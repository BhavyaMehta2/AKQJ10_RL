...
class KuhnTest():
    ...
    def gameValue(self):
        ...
        '''
        value = 0.
        cardList = [[1, 2], [1, 3], [1, 4], [1, 5], [2, 3], [2, 4], [2, 5], [3, 4], [3, 5], [4, 5], [2, 1], [3, 1], [4, 1], [5, 1], [3, 2], [4, 2], [5, 2], [4, 3], [5, 3], [5, 4]]
        ...
        for cards in cardList:
            value += valueRecursive(self, str(cards[0])) / 20
        return value
    ...
    def exploitability(self) -> list:
        ...
        output = [0, 0]
        for c in range(1, 6):  # Update the range to include cards from 1 to 5
            output[0] += gt[str(c)]['ev'] / 5
            output[1] -= gt[str(c)]['br'] / 5
        return output
    ...
    def best_response(self) -> dict:
        ...
        def traverseRecursive(self, history: str, reachProb: dict, gameTree: dict) -> dict:
            ...
            childCards = {"1": ["2", "3", "4", "5"], "2": ["1", "3", "4", "5"], "3": ["1", "2", "4", "5"], "4": ["1", "2", "3", "5"], "5": ["1", "2", "3", "4"]}
            ...
            return gameTree
        rp = {}
        RPList = ['10', '11', '20', '21', '30', '31', '40', '41', '50', '51']  # Update the list to include cards from 1 to 5
        for card in RPList:
            rp[str(card)] = 1
